...
function FavoriteTeam() {
    ...
    return (
        <CardContainer className="grid grid-cols-[1fr] w-full gap-y-4">
            ...
            <div className={`flex gap-x-3 border-b-1 ${t?.theme.border} pb-3`}>
                <div className={`w-[5rem] h-[5rem] rounded-full ${t?.theme.bgLight}`}></div>
            ...
            <div className="grid grid-cols-[1fr_1fr_1fr_1fr] place-items-center w-[100%]">
                <CardStatCategoryVertical category="W-L" value={'32-41'} className={`${t?.theme.border} border-r-1 px-4 w-[100%]`}/>
                <CardStatCategoryVertical category="PCT" value={.435} className={`${t?.theme.border} border-r-1 px-4 w-[100%]`} />
                <CardStatCategoryVertical category="GB" value={'0.5'} className={`${t?.theme.border} border-r-1 px-4 w-[100%]`} />
